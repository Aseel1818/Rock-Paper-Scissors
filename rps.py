...
class ReflectPlayer(Player):
    ...
    def move(self):
        return self.last_opponent_move if self.last_opponent_move is not None else 'rock'
...
class Game:
    ...
    def play_game(self):
        ...
        while True:
            ...
            self.play_round()
            userInput= input("enter 'exit' to quit or Enter to play another round: ").strip().lower()
            if userInput == 'exit':
                break
